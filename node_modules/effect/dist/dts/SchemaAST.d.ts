 ...
 * @experimental
 */
export declare const TypeConstructorAnnotationId: unique symbol;
/**
 * @category annotations
 * @since 3.10.0
 */
 ...
 * @experimental
 */
export declare const getTypeConstructorAnnotation: (annotated: Annotated) => Option.Option<TypeConstructorAnnotation>;
/**
 * @category annotations
 * @since 3.10.0
 */
