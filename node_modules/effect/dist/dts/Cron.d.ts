import type * as DateTime from "../../src/DateTime.js";
...
declare const ParseError_base: new <A extends Record<string, any> = {}>(args: import("../../src/Types.js").Equals<A, {}> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }) => import("../../src/Cause.js").YieldableError & {
